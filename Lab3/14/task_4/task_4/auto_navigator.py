...
class Navigation(Node):
    ...
    def __init__(self, node_name='Navigation'):
        ...
        map_yaml_path = '../maps/classroom_map.yaml'
        ...
        self.lookahead_dist = 0.5  # (meters) How far ahead on the path to look for a target
        self.speed_max = 0.15      # (m/s) Maximum linear speed
        self.goal_tolerance = 0.2  # (meters) How close to the final goal to be considered "arrived"
        self.align_threshold = 0.4 # (radians) Angle error above which the robot will stop and turn
